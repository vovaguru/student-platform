...
const StudentsList = () => {
  ...
  return (
    <main className="student">
      <h2 className="mb-2 mt-3 whitespace-break-spaces text-4xl font-bold text-primary underline decoration-inherit decoration-2 underline-offset-4 dark:mt-0 dark:text-slate-400 md:text-6xl">
        Список студентов
      </h2>
